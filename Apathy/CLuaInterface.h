...
namespace VT { class CLuaInterface; }; // You know whats funny? This is mine, not deaglers... w0w n
...
public:                                                                                                 //  Index Offset
	...
	virtual void   GetCFunction(int) = 0;  // 26
	...
	virtual void    PushCFunction(void*) = 0;       // 32
	virtual void    PushCClosure(void*, int) = 0;    // 33
	...
	//	virtual void*  GetClientsLuaInterfaces(void) = 88; // 133
};
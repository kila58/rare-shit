...
namespace GUI {
	...
	void __stdcall shitMenu()
	{
		...
		draw::String(true, variables::Menu::XPos + sizeW / 2, variables::Menu::YPos + 3, 5, colTextColor, "Apathy");
		...
		*/
		...
		{
			Checkbox(variables::Aimbot::Active, "Active [ +alt1 ]", posX, posY);
			Checkbox(variables::Aimbot::TargetTeammates, "Target Teammates", posX, posY);
			Separator();

			// Basic Settings
			Checkbox(variables::Aimbot::IgnoreSpawnProtection, "Ignore Spawn Protection", posX, posY);
			Checkbox(variables::Aimbot::IgnoreSteamFriends, "Ignore Steam Friends", posX, posY);
			Checkbox(variables::Aimbot::IgnoreNPCs, "Ignore NPCs", posX, posY);
			Separator();

			Checkbox(variables::Aimbot::Silent, "Silent Aimbot", posX, posY);
			//	Checkbox(variables::Aimbot::pSilent, "pSilent", posX, posY);// slows aimbot why because you are a gay autistic faggot that uses a shitty base oh :,(
			Separator();

			Checkbox(variables::Misc::AntiAntiAim, "Anti Anti-Aim", posX, posY);

			Column(posW / 2);

			Checkbox(variables::Aimbot::Legit, "Legit Mode", posX, posY);
			Slider(variables::Aimbot::LegitSpeed, "Speed", posX, posY, 1, 15);
			Slider(variables::Aimbot::LegitFOV, "Field of View", posX, posY, 1, 360);
		}
		else if (variables::Menu::Tab == "Visuals")
		{
			...
			Checkbox(variables::Visuals::Crosshair, "Crosshair", posX, posY); // Slider(variables::Visuals::Crosshair, "Crosshair", posX, posY, 0, 8);
			Separator();

			// Settings
			Separator();

			Checkbox(variables::Visuals::ShowNPCs, "Show NPCs", posX, posY);
			Checkbox(variables::Visuals::ShowWeapons, "Show Weapons", posX, posY);
			Checkbox(variables::Visuals::ShowSENTs, "Show SENTs", posX, posY);
		}
		...
		else if (variables::Menu::Tab == "Misc")
		{
			...
			Checkbox(variables::Misc::RapidFire, "IN_ATTACK Rapid Fire", posX, posY);
			Checkbox(variables::Misc::AltRapidFire, "IN_ATTACK2 Rapid Fire", posX, posY);
			Checkbox(variables::Misc::RapidUse, "IN_USE Rapid Spam", posX, posY);
			Checkbox(variables::Misc::BunnyHop, "IN_JUMP Bunny Hop", posX, posY);
			Checkbox(variables::Misc::Namesteal, "Namesteal", posX, posY);
			Separator();

			//Slider(variables::Misc::AAX, "Anti-Aim X", posX, posY, -360, 360, posW - 5);
			//	Slider(variables::Misc::AAY, "Anti-Aim Y", posX, posY, -360, 360, posW - 5);
			//	Slider(variables::Misc::FAX, "Fake Angles X", posX, posY, -360, 360, posW - 5);
			//	Slider(variables::Misc::FAY, "Fake Angles Y", posX, posY, -360, 360, posW - 5);

			Column(posW / 2);

			Checkbox(variables::Misc::FlashlightSpam, "Flashlight Spam", posX, posY);
			Checkbox(variables::Misc::Spam, "Spam", posX, posY);
			Checkbox(variables::Misc::RPSpam, "RP Spam", posX, posY);
			Checkbox(variables::Misc::KillSpam, "Killspam", posX, posY);
			Checkbox(variables::Misc::KillSounds, "Killsounds", posX, posY);
			Separator();

			Checkbox(variables::Misc::Fakelag, "pFakeLag", posX, posY);
			Checkbox(variables::Misc::FakeCrouch, "pFakeCrouch [W]", posX, posY);
			Slider(variables::Misc::AntiAim, "Anti-Aim", posX, posY, 0, 2.1);
			Text(false, posX, posY, 5, Color(240, 240, 240, 255), "[1] Basic");
		}
		...
		else if (variables::Menu::Tab == "Lua")
		{
			...
			Separator();
			Slider(variables::Lua::LoadCmdSource, "Apathy", posX, posY, 1, 4);
		...
		{
			Text(false, posX, posY, 5, Color(240, 240, 240, 255), "Apathy.");

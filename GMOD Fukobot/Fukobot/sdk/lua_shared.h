...
{
public:
	virtual void test() { /* do some test code */ };
};

class SomeOtherClass : public SomeClass
{
public:
	void test() { /* do some other code */ };
};
...
public:
	...
	virtual void *CLuaShared::FindScripts(std::string  const&, std::string  const&, std::vector<std::string, std::allocator<std::string>> &); // 15
};

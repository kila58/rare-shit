...
public:
	...
	void TabOperator(int x, int y, int w, int h, bool &tab1, bool &tab2, bool &tab3, bool &tab4, bool &tab5);
	...
	void DrawCheckBox(int x, int y, Color colour, const char* fmt, bool &option, Color back, const char* desc);
